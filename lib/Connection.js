...
module.exports = class Connection extends EventEmitter {
	...
	constructor(sock, dataManager){ 
		...
		var systemCommands = ['info', 'ping', 'monitor' ]
		this.systemCommands = {}
	...
	onSockData(data)
	{
        ...
        try{
        	...
        	var requestData = this.parser.fromRESP(data)
        	var cmd = requestData[0].toLowerCase()
        	requestData.shift()
        	...
        	{
        		var responseData = this[cmd]( this,  ...requestData)
        		resp = this.parser.toRESP( responseData , 'simpleString') 	
        		this.sock.write( resp );
        	}else
        	{

	        	var responseData = this.dataManager.execCommand(cmd, this, ...requestData)    
	...
	writeChannelMessage( channel, payload ){
		var data = ["message", channel, payload]
